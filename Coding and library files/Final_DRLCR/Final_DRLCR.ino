...
#define MAX_DISTANCE 200 // sets maximum useable sensor measuring distance to 300cm
...
#define TURN_DIST COLL_DIST + 30 // sets distance at which robot veers away from object
